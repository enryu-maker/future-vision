...
const CATEGORIES = [
  {
    ...
    tags: [
      ...
      "Event Entertainment Services Dubai",
    ],
  },
  {
    t: "Entertainers",
...
const DANCE_STYLES = [
  {
    t: "Latin American",
    c: "Salsa, Tango, Samba, and Columbian dance performances.",
  },
  {
    t: "Indian & Arabic",
    c: "Bollywood, Belly Dancers, Arabic Dancers, and Indian Classical.",
  },
...
const FEATURED_LABELS = [
  "Live Concert Dubai",
  "Carnival Showgirls",
  "Silver Dance Performers",
];

export default function EntertainmentPage() {
  const FEATURED = FEATURED_LABELS.map((label, i) => ({
    t: label,
    image: ENTERTAINMENT_IMAGES[i],
  }));
      ...
      <PageHero
        ...
        title={
          <>
            ...
            <em className="not-italic text-orange-500">Dubai</em>
          </>
        }
      ...
      <ParallaxReveal as="section" className="bg-surface py-28">
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-12 mt-10">
          ...
          <EditorialHeading className="mt-8 max-w-xl">
            Live performance for every occasion.
          </EditorialHeading>
          <p className="mt-6 max-w-2xl text-muted-foreground leading-relaxed text-base">
            We present performers with professionalism, great talent, and
            passion — experts who bring events to life.
          </p>
        ...
        <div className="mx-auto grid max-w-[1400px] gap-16 px-6 lg:grid-cols-12 lg:px-12">
          <div className="lg:col-span-5">
            ...
            <p className="mt-6 text-muted-foreground leading-relaxed text-base">
              From elegant violinists for formal corporate events to live bands
              and DJs for parties — good music is the life of any event.
            </p>
          </div>
