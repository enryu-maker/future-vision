...
const STATS = [
  {
    t: "14+ Years",
    c: "Experience in corporate events, weddings, and entertainment across the UAE and Middle East.",
    tags: ["Event Management Company Dubai", "Top Event Planners in Dubai"],
  },
  {
    t: "400+ Events",
    c: "Staff parties, product launches, exhibitions, and multi-day weddings successfully managed.",
    tags: [
  ...
  {
    t: "160+ Consultations",
    c: "Private consultations to understand vision, budget, and timeframe for every project.",
    tags: ["Event Planner Dubai", "Luxury Event Planner Dubai"],
  },
  {
    t: "100% Clients",
    c: "Happy clients who return to us for every milestone occasion across Dubai and UAE.",
    tags: ["Best Event Management Company in Dubai"],
  },
];
...
const PROCESS = [
  {
    t: "Visualization",
    c: "Visualize the event theme, idea, or motif for the party or occasion.",
  },
  {
    t: "Realization",
    c: "Realistic budgeting and time frame planning for the event or project.",
  },
  {
    t: "Implementation",
    c: "Create the plan in full detail — from concepts to tangible decorations.",
  },
  {
    t: "Execution",
    c: "Execute the plan at full scale, always paying attention to details.",
  },
];
        ...
        <div className="mx-auto grid max-w-[1400px] gap-16 px-6 lg:grid-cols-12 lg:px-12 items-center mt-10">
          <div className="lg:col-span-5">
            <ParallaxSideImage
              ...
              alt="Future Vision Events Dubai"
            />
          </div>
          <div className="lg:col-span-6 lg:col-start-7">
            ...
            <div className="mt-8 text-muted-foreground leading-[1.85] space-y-5 text-base">
              <p>
                As a full-service entertainment and event management company,
                Future Vision works with clients from concept development, venue
                selection, and technical planning through to managing the actual
                event production.
              </p>
              <p>
                For corporate events this includes travel, sound, light, stage
                setup, translation equipment, and exhibition stands. We also
                organize Arabic, Indian, and Western weddings with live
                entertainment — magicians, clowns, jugglers, and mascots.
              </p>
          ...
          <div className="mt-16 grid gap-px bg-border sm:grid-cols-2 lg:grid-cols-4">
            {STATS.map((v, i) => (
              ...
              >
                ...
                <h3 className="mt-6 font-display text-2xl lg:text-3xl text-cream">
                  {v.t}
                </h3>
