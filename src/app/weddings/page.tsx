...
const PROCESS = [
  {
    n: "I",
    t: "Consultation",
    c: "We meet with the couple to understand wishes, budget, and timeframe.",
  },
  {
    n: "II",
    t: "Proposal",
    c: "An initial proposal reflecting your ideas and personality within your budget.",
  },
  {
    n: "III",
    t: "Production",
    c: "Invitations, décor, florals, catering, and every detail brought to life.",
  },
  {
    n: "IV",
    t: "Celebration",
    c: "A stress-free wedding day — we handle everything so you can simply enjoy.",
  },
];

const GALLERY_LABELS = [
  "Floral Wedding Mandap",
  "Marble Aisle Wedding",
  "Blush Floral Stage",
  "Grand Ballroom Wedding",
];

export default function WeddingsPage() {
  const GALLERY = GALLERY_LABELS.map((label, i) => ({
    t: label,
    ...
    <>
      ...
      <ParallaxReveal as="section" className="bg-surface py-28">
        ...
        <div className="mx-auto grid max-w-[1400px] gap-16 px-6 lg:grid-cols-12 lg:px-12 mt-10">
          ...
          <div className="lg:col-span-6 lg:col-start-7 text-muted-foreground leading-[1.85] space-y-5 text-base">
            <p>
              As wedding planners in Dubai, Future Vision makes sure you enjoy
              your day while we take care of all preparations — Wedding Stage
              Décor, Indian Mandap, Doli, Palkhi, and fresh flower décor across
              the UAE.
            </p>
            <p>
              Our warehouse and equipment division keeps us cost competitive
              while ensuring excellent quality — all within your desired budget.
            </p>
            <p className="font-display italic text-orange-500 text-xl">
              Your wedding is something you&apos;ll treasure for the rest of
              your life.
            </p>
          </div>
        </div>
      ...
      <ParallaxReveal as="section" className="bg-background py-28">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
          ...
          <EditorialHeading className="mt-8 max-w-xl">
            Arabic, Indian &amp; Western weddings.
          </EditorialHeading>
          <div className="mt-16 grid gap-px bg-border lg:grid-cols-3">
            {TRADITIONS.map((s) => (
              ...
              >
                ...
                <p className="mt-5 text-base sm:text-sm text-muted-foreground leading-relaxed flex-grow">
                  {s.c}
                </p>
                <ul className="mt-6 space-y-2">
                  {s.services.map((item) => (
                    <li
                      key={item}
                      className="text-base sm:text-sm text-muted-foreground before:mr-2 before:text-orange-500 before:content-['—']"
                    >
                      {item}
                    </li>
                  ))}
      ...
      <ParallaxReveal as="section" className="bg-background py-28">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
          ...
          <EditorialHeading className="mt-8">
            From first meeting to wedding day.
          </EditorialHeading>
      ...
      <ParallaxReveal as="section" className="bg-surface py-32">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <span className="font-display text-[6rem] sm:text-[8rem] leading-none text-orange-500/50">
            &ldquo;
          </span>
          ...
          <p className="eyebrow mt-4">
            Future Vision Events &amp; Weddings &middot; Dubai
          </p>
          <SeoTags
            className="justify-center mt-4"
            compact
            tags={["Wedding Planner Dubai", "Wedding Decoration Dubai"]}
          />
        </div>
      </ParallaxReveal>
