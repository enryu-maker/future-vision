...
const EVENT_TYPES = [
  {
    n: "01",
    title: "Conferences",
    body: "Multi-day conferences, seminars, and business meetings with full AV, staging, and guest management.",
    tags: [
      "Conference Organizer Dubai",
  ...
  },
  {
    n: "02",
    title: "Exhibitions",
    body: "Custom exhibition stands, trade shows, and branded environments for expos across Dubai.",
    tags: [
      "Exhibition Management Company Dubai",
  ...
  },
  {
    ...
    body: "Brand activations, experiential marketing, and launch events that make your product unforgettable.",
    tags: [
      "Product Launch Event Agency Dubai",
  ...
  },
  {
    n: "04",
    title: "Gala Dinners",
    body: "Annual galas, award ceremonies, and VIP evenings with luxury production and entertainment.",
    tags: [
      "Gala Dinner Organizer Dubai",
      ...
      >
        <div className="mx-auto grid max-w-[1400px] gap-12 px-6 lg:grid-cols-12 lg:gap-16 lg:px-12">
          ...
          <div className="lg:col-span-6 lg:col-start-7 space-y-6 text-muted-foreground leading-[1.85] text-base sm:text-lg">
            <p>
              Future Vision Events is one of the UAE&apos;s leading event
              management companies, dedicated to creating memorable experiences
              through innovative planning, flawless execution, and exceptional
              customer service.
            </p>
            <p>
              From intimate celebrations to large-scale corporate events, our
              experienced team manages every detail with precision and
              creativity. Our commitment to quality, reliability, and customer
              satisfaction has earned us the trust of clients across the UAE.
            </p>
            <p>
              Whether it is a corporate conference, product launch, exhibition,
              wedding, gala dinner, or entertainment event, we transform every
              vision into reality.
            </p>
            <SeoTags
              tags={[
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
          ...
          <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {WHY_CHOOSE.map((item) => (
              ...
              >
                <CheckCircle2
                  className="mt-0.5 h-6 w-6 shrink-0 text-orange-500"
                  strokeWidth={2}
                />
                <p className="font-display text-xl sm:text-2xl font-bold text-cream leading-snug">
                  {item}
                </p>
              </div>
            ))}
              ...
              >
                ...
                <div className="flex flex-1 flex-col gap-4 p-6 sm:p-8">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      <span className="font-display text-lg text-orange-500/80">
                        {s.n}
                      </span>
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4 sm:gap-5">
            {EVENT_TYPES.map((p) => (
              <div
                key={p.n}
                className="bg-background border border-border rounded-xl p-8 lg:p-10 flex flex-col shadow-sm"
              >
                <span className="font-display text-3xl sm:text-2xl text-orange-500">
                  {p.n}
                </span>
                <Hairline className="mt-6 w-12!" />
                <h3 className="mt-6 font-display text-2xl lg:text-3xl font-bold text-orange-500 leading-tight">
                  {p.title}
                </h3>
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <GoldButton
                  ...
                  to={c.href}
                  variant="solid"
                  className="px-5! py-3! text-[0.68rem]!"
                >
                  {c.label}
                </GoldButton>
              ))}
