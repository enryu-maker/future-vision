...
const TYPES = [
  {
    t: "Annual Staff Parties",
    c: "Theme-driven celebrations for employees — holiday gatherings, milestone recognition, and annual corporate events across Dubai.",
    tags: ["Annual Corporate Event Dubai", "Corporate Event Management Dubai"],
  },
  {
    t: "Team Building Events",
    c: "Outdoor programmes and team activities designed to strengthen bonds between employees and departments.",
    tags: ["Team Building Events Dubai", "Team Building Event Organizer Dubai"],
  },
  {
    t: "Gala Dinners",
    c: "Black-tie galas, award ceremonies, and VIP evenings with full creative direction and entertainment.",
    tags: [
  ...
  {
    t: "Product Launches",
    c: "Press previews, brand activations, and launch parties with creative staging, AV, and guest management.",
    tags: [
  ...
  {
    t: "Exhibition Stands",
    c: "Custom-built stands and branded environments for trade shows and exhibitions across Dubai.",
    tags: ["Exhibition Stand Contractor Dubai", "Trade Show Organizer Dubai"],
  },
  {
    t: "Conferences",
    c: "Formal corporate conferences and business meetings — travel, translation, sound, light, and stage setup.",
    tags: [
  ...
  {
    t: "Desert & Dhow Events",
    c: "Authentic desert experiences and dhow celebrations with full production, catering, and entertainment.",
    tags: [
...
const PROCESS = [
  {
    n: "01",
    t: "Brief",
    c: "Discovery session to understand your objectives, budget, and event requirements.",
  },
  {
    n: "02",
    t: "Plan",
    c: "Realistic budgeting, timeline planning, and vendor selection aligned with your goals.",
  },
  {
    n: "03",
    t: "Build",
    c: "Full detail production — staging, décor, logistics, and technical setup.",
  },
  {
    n: "04",
    t: "Deliver",
    c: "Flawless on-the-day execution with attention to every detail.",
  },
];
...
const HIGHLIGHTS = [
  {
    t: "Celebrations",
    c: "Top event planners in Dubai for celebrating any corporate achievement or milestone.",
    tags: ["Corporate Event Organizer Dubai", "Top Event Planners in Dubai"],
  },
  {
    t: "Meetings",
    c: "Product launches, success parties, and professional gatherings planned for maximum impact.",
    tags: [
  ...
  {
    t: "Full Production",
    c: "Sound, light, stage, translation equipment, travel, and exhibition stands under one roof.",
    tags: [
      "Corporate Event Production Dubai",
    ...
    <>
      <PageHero
        ...
        title={
          <>
            ...
            <em className="not-italic text-orange-500">Dubai</em>, UAE
          </>
        }
      ...
      <ParallaxReveal as="section" className="bg-surface py-28">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
          <SeoTags
            tags={[
              "Corporate Event Management Company in Dubai",
              "Corporate Event Planner Dubai",
              "Corporate Event Organizer Dubai",
        ...
        <div className="mx-auto grid max-w-[1400px] gap-16 px-6 lg:grid-cols-12 lg:px-12 mt-10">
          <div className="lg:col-span-5">
            ...
            <EditorialHeading className="mt-8">
              A premier corporate event company.
            </EditorialHeading>
          </div>
          <div className="lg:col-span-6 lg:col-start-7 text-muted-foreground leading-[1.85] space-y-5 text-base">
            <p>
              Future Vision is one of the premier event management companies in
              Dubai, famed for quality, planning, and management of corporate
              events across the UAE.
            </p>
            <p>
              We work with clients from concept development and venue selection
              through technical planning to managing the actual event production
              — including travel, sound, light, stage setup, translation
      ...
      <ParallaxReveal as="section" className="bg-background py-28">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
          ...
          <EditorialHeading className="mt-8 max-w-xl">
            Corporate events we produce.
          </EditorialHeading>
          <div className="mt-16 grid gap-px bg-border sm:grid-cols-2 lg:grid-cols-3">
            {TYPES.map((x) => (
              ...
              >
                <h3 className="font-display text-2xl lg:text-3xl text-orange-500">
                  {x.t}
                </h3>
      ...
      <ParallaxReveal as="section" className="bg-surface-2 py-28">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
          ...
          <EditorialHeading className="mt-8">
            Corporate event planners you can trust.
          </EditorialHeading>
      ...
      <ParallaxReveal as="section" className="bg-surface py-28">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
          ...
          <p className="mt-6 max-w-2xl text-muted-foreground leading-relaxed text-base">
            Careful planning is the secret to a successful event. We work
            closely with clients from concept through to the final guest
            departure.
          </p>
          <div className="mt-16 grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
            {PROCESS.map((p) => (
              <div key={p.n}>
                <span className="font-display text-4xl sm:text-3xl text-orange-500">
                  {p.n}
                </span>
                <Hairline className="mt-5 w-10!" />
                <h3 className="mt-5 font-display text-2xl sm:text-xl text-orange-500">
                  {p.t}
                </h3>
                <p className="mt-3 text-base sm:text-sm text-muted-foreground leading-relaxed">
                  {p.c}
                </p>
              </div>
            ))}
